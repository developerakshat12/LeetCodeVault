...
import { Clock, Code, Bookmark, CheckCircle, AlertCircle } from "lucide-react";
      ...
      <CardContent className="p-6">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <p className="text-muted-foreground text-sm mb-3">{problem.description || "No description available"}</p>
            <div className="flex items-center space-x-4 text-sm text-muted-foreground">
              ...
              <span className="flex items-center">
                ...
                Last edited {formatDate(problem.lastEdited)}
              </span>
              <span className="flex items-center">
                {getStatusIcon()}
